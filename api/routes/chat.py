    ...
    async def ai_stream():
        ...
        if keyword == "product" or keyword == "response":
            ...
            SYSTEM_TEMPLATE = """
                ...
                - After a thorough semantic analysis of the provided PRODUCT DATABASE, we will return the PRODUCT. Specifically, if a user requested an RC TRUCK, we will return the TRUCK, not other parts or other products. This is what we mean by RC TRUCK (CARS), not Bumper, not options, not parts etc.
                ...
                - If you have already recommended a product for a similar product request in a friendly conversation, do not recommend that product in your next response.
